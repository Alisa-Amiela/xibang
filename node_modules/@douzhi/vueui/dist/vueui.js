...
Vue.component("dz-breadcrumb-item", {
  template: `<span><a><cite><slot></slot></cite></a><span lay-separator>/</span></span>`
});
...
Vue.component("dz-card", {
  render(createElement) {
    let childs = [];
    if (this.$slots.header) {
      childs.push(
        createElement("div", { class: "layui-card-header" }, [
          this.$slots.header
        ])
      );
    }
    if (this.$slots.body || this.$slots.default) {
      childs.push(
        createElement("div", { class: "layui-card-body" }, [
          this.$slots.body || this.$slots.default
        ])
      );
    }
    return createElement("div", { class: "layui-fluid" }, [
      createElement("div", { class: "layui-card" }, childs)
    ]);
  }
});
...
<div class="layui-form-item">
  <label class="layui-form-label">{{label}}</label>
  <div class="layui-input-block">
    <input type="password" :name="name" :placeholder="placeholder" autocomplete="off" class="layui-input" v-bind:value="value" v-on:input="$emit('input', $event.target.value)"> 
  </div>
</div>  
  `
});
...
<div class="layui-form-item">
  <label class="layui-form-label">{{label}}</label>
  <div class="layui-input-block">
  <textarea :name="name" :id="layeditId" :layedit-index="layeditIndex" :placeholder="placeholder" class="layui-textarea" v-on:input="$emit('input', $event.target.value)">{{value}}</textarea>
  </div>
</div>  
  `,
  mounted() {
...
<div class="layui-form-item">
  ...
  <div class="layui-input-inline" style="width:300px">
    <input class="layui-input" :placeholder="placeholder" :name="name" :value="filename?filename:value" v-on:input="$emit('input', $event.target.value)">
  </div>
...
Vue.component("item", {
  render(createElement) {
    ...
    switch (componentName) {
      case "dz-breadcrumb":
        return createElement("dz-breadcrumb-item", null, [this.$slots.default]);
    }
  }
});
  ...
  <div class="form">
    ...
    <div class="layui-form">
      ...
      <div class="layui-form-item">
        ...
        <input class="layui-input" placeholder="密码">
      </div>
      <div class="layui-form-item">
        <button class="layui-btn layui-btn-fluid">点击登录</button>
      </div>
    </div>
  </div>
</div>`
